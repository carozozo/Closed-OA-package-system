...
$.mNav = (function () {
    ...
    var createNav = function (dNav) {
        ...
        dNav.append(dNavHeader).append(dNavLeft).append(dNavRight);
        self.dNav = dNav;
    ...
    self.createNav = function () {
        var dNav = $('<nav></nav>').lClass('navbar navbar-default').lId(selfId).attr('role', 'navigation');
        createNav(dNav);
    };
...
//            aSideOpt.sortByObjKey('order');
    ...
    self.getHeader = function () {
        return self.dNavHeader;
    };
    self.getLeft = function () {
        return self.dNavLeft;
    };
    self.getRight = function () {
        return self.dNavRight;
    };
    self.getTab = function (id) {
        return self.dNav.find('#' + navTabClass + '-' + id);
    };
    ...
    self.getDropDown = function (id) {
        return self.dNav.find('#' + navDropDownClass + '-' + id);
    };
